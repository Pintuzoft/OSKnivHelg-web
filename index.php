...
echo "        <p style='font-size:14px'>Admin-Jaktsäsongen på OldSwedes har startat!, Efter Jul och nyår har våra admins <br>\n";
echo "        blivit fullproppade med mat och godsaker, så det är dags att få dem att springa av sig lite :)<br>\n";
echo "        dock är det enda sättet att få tyst på dem odågorna att kniva dem i ryggen :D<br>\n";
